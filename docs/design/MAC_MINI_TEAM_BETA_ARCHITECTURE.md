...
#### 0.8.9 第二台 Mac mini 复用 runbook(v1.2 · 基于 poju-mini 实测)
...
- `SKILL_ROOT=~/Desktop/skills/团队版` + symlink 到 `~/skills-source/` 可读 39 个 skill;公众号 skill 实测 `SKILL.md` 13994 字符、5 篇 references
...
**END · v1.2 · 2026-05-01 · 已补首台 Mac mini 实测 runbook · 可复用到下一台 Mac mini**

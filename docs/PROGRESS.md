...
## 当前状态 (2026-04-30 · T-048/T-065 返修完成待独立 QA)

**版本**: v0.8.5-copy-frame-repair — T-048/T-065 找到的内容页技术词和 `beta` iframe 本机路径外露已由总控返修; frame-aware 全站 21 页扫描 0 命中, 等 T-066 独立 QA 复测后关闭。
...
- T-066 待入队: 让 QA 按 T-065 同口径复测本次返修, 必须包含 frame-aware 扫描和 Dreamina 失败任务假数据, 不烧 credits。

...
## "做视频"流程重塑(D-061 系列) — sidebar 收敛 + 文案大板块
...
- [ ] **D-061b** PageMake 重塑骨架 (5-6 步 wizard 空 step 占位)
- [ ] **D-061c** Step 1 文案板块 (N 个大按钮, 跳现有 skill)
- [ ] **D-061d** Step 2 声音 + 数字人 mp4 合并一步
- [ ] **D-061e** Step 3 选模板 (复用 dhv5 模板选择器组件)
- [ ] **D-061f** Step 4 剪辑 (复用 dhv5 align + render)
- [ ] **D-061g** Step 5 预览 + 修改意见反馈
- [ ] **D-061h** cleanup: PageDhv5 标 deprecated · 文档更新 · KNOWN_ISSUES sync

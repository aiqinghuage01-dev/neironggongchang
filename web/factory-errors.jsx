...
const ERROR_PATTERNS = [
  ...
  { match: /scene_idx.*超界|out.?of.?range/i,
    icon: "🔀", title: "镜头和模板没对上",
    suggestion: "回第 3 步重新选模板, 再重新对齐一次" },
  { match: /只.*B.?C.?scene.*broll|only.*B.?C.*broll/i,
    icon: "🖼️", title: "这个场景不需要配图",
    suggestion: "口播镜头不用配图, 只给补画面镜头配图; 检查你点的是哪类镜头" },
  { match: /缺.*prompt|没法生图.*prompt/i,
    icon: "✏️", title: "画面描述是空的",
    suggestion: "在场景卡里填一行画面描述 (至少 5 字) 再点生图" },
  { match: /柿榴|qingdou/i,
    icon: "🛠️", title: "柿榴异常",
